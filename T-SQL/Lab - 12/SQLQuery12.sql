...
SELECT BRANCH,COUNT(S.RNO) AS C_SPI
FROM STUDENT_INFO S 
INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY BRANCH
...
SELECT BRANCH,COUNT(S.RNO) AS C_STU
FROM STUDENT_INFO S 
INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY BRANCH
...
SELECT BRANCH,MAX(R.SPI) AS MAX_SPI
FROM STUDENT_INFO S 
INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY BRANCH
...
SELECT BRANCH,AVG(R.SPI) AS AVG_SPI
FROM STUDENT_INFO S 
INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY BRANCH
...
SELECT BRANCH,MAX(R.SPI) AS MAX_SPI,MIN(R.SPI) AS MIN_SPI
FROM STUDENT_INFO S 
INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY BRANCH
