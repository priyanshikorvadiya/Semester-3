...
SELECT FORMAT(GETDATE(),'MMM d yy h:mmtt') AS FORMATDATE

--4. Display the current date in a format that appears as 03 Jan 1995.

SELECT FORMAT(GETDATE(),'d MMM yy') AS FORMATDATE

--5. Display the current date in a format that appears as Jan 04, 96. 

SELECT FORMAT(GETDATE(),'MMM d, yy') AS FORMATDATE
...
SELECT DATEDIFF(HOUR, '2012-01-25 7:00','2012-01-26 10:30') AS MONTHDIFF
...
SELECT DATEADD(YEAR,5,'2026-07-15') AS AFTERYEAR

--10. Write a query to subtract 2 months from current date.

SELECT DATEDIFF(MONTH,'2026-05-15','2026-07-15') AS BEFOREYEAR

--11. Extract month from current date using datename () and datepart () function.

SELECT DATEPART(MONTH,'2026-07-15') AS CURRENTMONTH
SELECT DATENAME(MONTH,'2026-07-15') AS CURRENTMONTH
...
SELECT DATEDIFF(YEAR,'2008-09-30','2026-07-15') AS AGEYEAR
SELECT DATEDIFF(MONTH,'2008-09-30','2026-07-15') AS AGEMONTH
...
SELECT DATEDIFF(DAY,ADATE,GETDATE()) AS DIFF FROM DEPOSIT